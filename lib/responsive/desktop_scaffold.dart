...
class _DesktopScaffoldState extends State<DesktopScaffold> {
  ...
  List<String> banner_name=["Oil","Seed"];
  List<String> banner_url=[
    "https://firebasestorage.googleapis.com/v0/b/minsapventures.appspot.com/o/slides%2Fminssap_19.jpg?alt=media&token=29d87862-89d6-4ca4-8b7e-28e0c9864f1c",
    "https://firebasestorage.googleapis.com/v0/b/minsapventures.appspot.com/o/slides%2Fminssap_64.jpg?alt=media&token=812af01b-84d6-45d1-a884-0811d948eab8"
  ];
                                                          ...
                                                          FutureBuilder<QuerySnapshot>(
                                                            ...
                                                            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                                              if (!snapshot.hasData) {
                                                                ...
                                                                return const Text("Error loading slides");
                                                              }

                                                              // Retrieve the list of documents (slides) from Firestore
                                                              List<QueryDocumentSnapshot> slides = snapshot.data!.docs;

                                                              // Create a list of images or widgets for the carousel
                                                              List<Widget> slideWidgets = slides.map((doc) {
                                                                var data = doc.data() as Map<String, dynamic>;
                                                                String imageUrl = data['url']; // Assuming 'imageUrl' field in Firestore
                                                              ...
                                                              // Display CarouselSlider with fetched slides
                                          ...
                                          Expanded(
                                              child: Container(
                                                ...
                                                child: Stack(
                                                  fit: StackFit.expand,
                                                  children: [
                                                    CachedNetworkImage(fit: BoxFit.cover, imageUrl: banner_url[0],),
                                                    Center(
                                                      child: Container(
                                                        height: 300,
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                BannerPost(title: banner_name[0], subTitle: 'Quality And Durable', imageUrl: banner_url[0], conColor: Colors.lightBlue[50],),
                                BannerPost(title: banner_name[1], subTitle: 'Quality And Durable', imageUrl: banner_url[1], conColor: Colors.lightGreen[50]),
                              ],
                            ),
                          )
                        ),
                            ...
                            child: FutureBuilder<QuerySnapshot>(
                              ...
                              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                if (!snapshot.hasData) {
                                  ...
                                  return const Text("Error loading blog posts");
                                }

                                // Retrieve the list of documents (blogs) from Firestore
                                List<QueryDocumentSnapshot> blogs = snapshot.data!.docs;

                                // Create a list of BlogPost widgets with data from Firestore
                                List<Widget> blogWidgets = blogs.map((doc) {
                                  var data = doc.data() as Map<String, dynamic>;
                                  String title = data['title'] ?? 'No Title'; // Assuming 'title' field in Firestore
                                  String mainText = data['mainText'] ?? 'No Content'; // Assuming 'mainText' field
                                  String date = data['date'] ?? 'No Date'; // Assuming 'date' field
                                  String comments = data['comments']?.toString() ?? '0'; // Assuming 'comments' field
                                  String imageUrl = data['imageUrl']; // Assuming 'imageUrl' field
                                ...
                                // Return the Wrap widget with the dynamic blog posts
                                return Wrap(
                                  spacing: 5,
                                  runSpacing: 5,
                                  alignment: WrapAlignment.center,
                                  children: blogWidgets, // Using dynamic blog post widgets
                                );
                              },
                            )
