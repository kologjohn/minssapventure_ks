...
class Ecom extends ChangeNotifier{
      ...
      if(alreaypaid.exists)
      {
        ...
        else
        {
          ...
          if (user != null) {
            ...
            var request = http.Request('POST', Uri.parse('https://paystackcall-hgumzteyxq-uc.a.run.app'));
  ...
  currecy() async {
    ...
    if (user != null) {
      ...
      var request = http.Request('POST', Uri.parse('https://currency-hgumzteyxq-uc.a.run.app'));
      request.body = json.encode({
        "data": {
          "email": email,
        }
